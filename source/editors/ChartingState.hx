...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Change Stage', "Cambia la stage del mod a la nueva o la vieja\ndependiendo del valor indicado en el \"Value 1.\"\n\nColoca en el Value 1 \"new\" para mostrar la\nnueva stage.\nColoca en el Value 1 \"old\" para mostrar la\nvieja stage.\n\nEste evento solo funciona si está seleccionada la\n\"Stage-Rami-Changer\" en cualquier canción."],
