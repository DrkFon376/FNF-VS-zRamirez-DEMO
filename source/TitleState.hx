...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		// IGNORE THIS!!!
		titleJSON = Json.parse(Paths.getTextFromFile('images/zRamirezDanceTitle.json'));
		...
		#else
		if(/*FlxG.save.data.flashing == null && */(FlxG.save.data.flashingWarningEnabled == null || (FlxG.save.data.flashingWarningEnabled != null && FlxG.save.data.flashingWarningEnabled)) && !FlashingState.leftState) {
	...
	function startIntro()
	{
		if (!initialized)
		{
			...
			// music.loadStream(Paths.music('zRamirezMenu'));
			// FlxG.sound.list.add(music);
			// music.play();

			if(FlxG.sound.music == null) {
				FlxG.sound.playMusic(Paths.music('zRamirezMenu'), 0);
			}
		}
		...
		logoBl.frames = Paths.getSparrowAtlas('zRamirez_logoBumpin');
		...
		zRamirezDance = new FlxSprite(titleJSON.gfx, titleJSON.gfy);
		...
		add(zRamirezDance);
		zRamirezDance.shader = swagShader.shader;
		add(logoBl);
