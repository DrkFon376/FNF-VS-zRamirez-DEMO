...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Edu_YT',					'edu',				'Helped to Create the Super Awesome Cutscenes for Story Mode, Beta Tester',												'https://www.youtube.com/channel/UCNQ2dXLiMe5iYyKIwJiaTxg',			'209520'],
			[''],
			['Discord Servers'],
			...
			['SqirraRNG',				'sqirra',			'Crash Handler',																										'https://x.com/gedehari',											'E1843A'],
			['iFlicky',					'flicky',			'Composer of Tea Time',																									'https://x.com/flicky_i',											'9E29CF'],
			[''],
			["Funkin' Crew"],
