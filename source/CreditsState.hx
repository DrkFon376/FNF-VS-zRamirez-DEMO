...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['DrkFon376',				'drkfon',			'Mod Co-Owner, Coder, Musician, Help with FLA Files, Charter design, Override cutscene voice actor and Fixed Some Bugs','https://www.youtube.com/channel/UCCVTns4b43V8Q5EON8xuSUQ',			'0A5DAF'],
			['Glowsoony',				'glow',				'Main Coding, Ported GPU Caching from Psych 0.7, Helped to Port the Hold Splashes from the V-Slice and more',			'https://www.youtube.com/channel/UCQQo4VDFWv_LX6tHzmBu8kA',			'66AFEC'],
			['Edu_YT',					'edu',				'Helped to Create the Super Awesome Cutscenes for Story Mode, Intervention cutscene voice actor and Beta Tester',		'https://www.youtube.com/channel/UCNQ2dXLiMe5iYyKIwJiaTxg',			'209520'],
			[''],
			['Discord Servers'],
			...
			['Official Psych Engine Discord', 	'discord', 			'Join the Psych Ward!', 																														   'https://discord.gg/2ka77eMXDv', 		'5165F6'],
			[''],
			['Extra Mod Credits'],
			['Ara',						'ara',				'Override cutscene voice actor, Character Designer and She gave us permission to use her character for the mod (Thanks Sweetie :3)','https://discord.gg/g2mCEc9rH5',						'A02EFF'],
			['Zero-Black',				'0',				'Designer of the new life icons',																						'https://youtube.com/@zeroblackyu?si=Buw96RA6buCwoP2w',				'EF7216'],
			['DonoNaza_UwU',			'dono',				'Tree stage designer',																									'https://www.youtube.com/@DonoNaza_UwU',							'AE267B'],
			['Iandee',					'iandee',			'Creator of the Original Design of the BF and GF Sprites from the VS Impostor Dialogues and Creator of the Pico Design',	'https://www.youtube.com/channel/UCnoOhpnxHWtayIJUCutfP7w',		'B0B0B0'],
			...
			['AlexSucks',				'alexsucks',		'Original designer of the sketch used to create Ara sprites',															'https://x.com/alexsucks8k/status/1877117678189441405',				'B0B0B0'],
